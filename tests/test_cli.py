...
class TestBuildOpensearchUrl:
    ...
    def test_basic_url(self):
        ...
        assert url == "opensearchs://admin:pass@host.com:9200/index"
    ...
    def test_url_encodes_special_chars_in_password(self):
        ...
        assert url == "opensearchs://admin:pass%21word%23123@host.com:9200/index"
...
class TestMkurlCommand:
    ...
    def test_mkurl_parse_url(self):
        ...
        # Check URL is in output (now uses opensearchs:// scheme)
        assert "opensearchs://admin:pass%21word@host.com:9200/myindex" in result.output
    ...
    def test_mkurl_enter_components(self):
        runner = CliRunner()
        # Simulate choosing option 2 (enter components) with TLS yes/no prompt
        result = runner.invoke(
            cli.app,
            ["mkurl"],
            input="2\nyes\nmyhost.example.com\n443\nadmin\nsecretpass\ndevlogs-prod\n"
        ...
        assert result.exit_code == 0
        # Check URL is constructed correctly with opensearchs:// scheme
        assert "opensearchs://admin:secretpass@myhost.example.com:443/devlogs-prod" in result.output
        # Check env vars
    ...
    def test_mkurl_enter_components_no_credentials(self):
        ...
        assert result.exit_code == 0
        assert "opensearch://localhost:9200/test-index" in result.output
