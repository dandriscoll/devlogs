...
def test_index(opensearch_client):
	...
	previous_index = os.getenv("DEVLOGS_INDEX_LOGS")
	os.environ["DEVLOGS_INDEX_LOGS"] = index_name
	yield index_name
	if previous_index is None:
		os.environ.pop("DEVLOGS_INDEX_LOGS", None)
	else:
		os.environ["DEVLOGS_INDEX_LOGS"] = previous_index
